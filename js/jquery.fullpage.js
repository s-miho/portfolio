...
$(document).ready(function() {
  $('#fullpage').fullpage();
  onLeave: $('.fadein'+'.animated').waypoint({
    handler(direction) {
      if (direction === 'down') {
...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        options = $.extend({
            ...
            //navigation:
            menu: '#menu',
            anchors: ['title', 'aboutme', 'works', 'skill', 'contact'],
            lockAnchors: false,
            navigation: true,
            navigationPosition: 'right',
            navigationTooltips: ['title', 'aboutme', 'works', 'skill', 'contact'],
            ...
            sectionsColor : ['#FFFFF0', '#E6C5B2', '#F7DD92', '#6CABB2', '#FFFFF0'],
            paddingTop: 0,
            paddingBottom: 0,
            fixedElements: null,
            responsive: 767, //backwards compabitility with responsiveWiddth
            responsiveWidth: 0,
            responsiveHeight: 0,
